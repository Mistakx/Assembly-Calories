...
MenuChangeFoodCall: ; ([B_CHANGE], TableNumber)
  ...
  MOV                                   R2, [R0]                              ; Move o valor do B_CHANGE para R2
  CMP                                   R2, 1
  JNE                                   MenuChangeFoodCallChangeNotPressed
  
  ; Se o butão B_CHANGE for pressionado
  ADD                                   R1, 2
 
  ; Se o butão B_CHANGE não for pressionado
  MenuChangeFoodCallChangeNotPressed    :
  ChoiceAveia                           :
  CMP                                   R0, 0
  JNE                                   ChoicePaoForma
...
MenuScaleCall: ; ([PESO], [B_CHANGE], PesoAnterior)
  ...
  MOV                                   [R0], R1                              ; Reset do periférico [B_CHANGE] antes de entrar no próximo menu                                   
